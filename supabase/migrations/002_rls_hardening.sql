...
-- ============================================================
-- CARTS — rebuild for auth-only model (session_id column removed)
-- ============================================================
...
-- Enforce: a user can only create a cart for themselves.
-- The UNIQUE constraint on user_id in the table prevents duplicates,
-- but this policy is the RLS-layer defense.
...
-- ============================================================
-- CART ITEMS — add explicit WITH CHECK clauses to UPDATE/INSERT
-- to prevent a user from reassigning items to another cart.
-- ============================================================
...
-- Shared sub-query extracted as a comment for clarity.
-- Checks: the target cart belongs to the current user.
...
-- WITH CHECK prevents changing cart_id to a cart that isn't theirs.
